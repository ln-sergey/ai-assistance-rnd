...
3. **Заполнить pending'и.** Открыть актуальный
   `prompts/synthesize-card-vN.txt` (на 2026-04-27 — `v6`), читать
...
- Голос организатора, не «признание» (§3 промпта v6 для критических
  правил TXT-05/11/14/17 — три архетипа: наивный / эвфемизирующий /
  нишевой).
- Без побочных нарушений: TXT-19/25/26/27/30/33 — самые частые
  нечаянные загрязнения.
