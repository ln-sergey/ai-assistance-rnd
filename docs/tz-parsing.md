...
Следующая сессия(и) AI-агента. Этот документ самодостаточен: читается
«с холода», предполагает только знание `AGENTS.md`, `ARCHITECTURE.md`,
...
- **Ретрай**: 2 попытки на 5xx/сетевые ошибки, экспоненциальный бэкофф
  ...
  описаны в `AGENTS.md` §8**, но это другой клиент (parser ≠ LLM-
